...
public class UserController {
	...
	public String edit(@PathVariable("userId") final Long userId, final Model model, final RedirectAttributes redirectAttrs) {
	...
	public String show(@PathVariable("userId") final Long userId, final Model model, final RedirectAttributes redirectAttrs) {
		User user = userService.findById(userId);
		if (user == null) {
			redirectAttrs.addFlashAttribute(ATTRIBUTE_INFO_MESSAGE_TYPE, INFO_MESSAGE_TYPE_ERROR);
			redirectAttrs.addFlashAttribute(ATTRIBUTE_INFO_MESSAGE, CODE_MESSAGE_USER_NOTFOUND);
	...
	public String addUser(final User user, final Model model, final RedirectAttributes redirectAttrs, final BindingResult bindingResult) {
	...
	public String updateUser(final User user, final Model model, final RedirectAttributes redirectAttrs, final BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			return BASE_URL_TEMPLATE + TEMPLATE_CREATE_OR_EDIT;
		}
	...
	public String deleteUser(final User user, final Model model, final RedirectAttributes redirectAttrs, final BindingResult bindingResult) {
