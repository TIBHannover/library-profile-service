...
public class DocumentAssignmentFinder {
	...
	public User determineAssignee(final DocumentMetadata documentMetadata) {
		if (documentMetadata.getDeweyDecimalClassifications() != null && documentMetadata.getDeweyDecimalClassifications().size() > 0) {
	...
	/**
	 * Determine the {@link User} the given {@link DocumentMetadata} should be assigned to. Use Dewey-Classification to determine the user.
	 * @param documentMetadata
	 * @return the assignee; null, if no assignee could be determined
	 */
	...
	/**
	 * Check if the given ddc-String is included in the given ddc-Category. Any trailing '0' of the given {@link Category} may be truncated.
	 * @param ddcCategory
	 * @param ddc
	 * @return
	 */
