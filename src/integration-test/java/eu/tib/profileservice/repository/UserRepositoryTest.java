...
public class UserRepositoryTest {
  ...
  public void testUserRepository() {
    ...
    entityManager.persist(newUser("name", "pw", "np", Arrays.asList(new Category[] {category1,
        category3})));
  ...
  public void testDeleteUser() {
    Category category1 = newCategory(Category.Type.DDC, "CAT1");
    category1 = entityManager.persist(category1);
    User user = entityManager.persist(newUser("name", "pw", "np", Arrays.asList(new Category[] {
        category1})));
